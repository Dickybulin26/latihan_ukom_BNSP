            ...
            <div class="card-body">
                <form action="{{ route('barang.update', $data->id_barang) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input disabled type="number" name="id_barang" id="id_barang" placeholder="ID" autofocus
                            class="form-control" value="{{ $data->id_barang }}">
                    </div>
                    <div class="mb-3">
                        <label for="nama_barang" class="form-label">nama</label>
                        <input disabled type="text" name="nama_barang" id="nama_barang" placeholder="nama barang"
                            class="form-control" value="{{ $data->nama_barang }}">
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">harga</label>
                        <input disabled type="number" name="harga" id="harga" placeholder="harga"
                            class="form-control" value="{{ $data->harga }}">
                    </div>
                    <div class="mb-3">
                        <label for="stok" class="form-label">stok</label>
                        <input disabled type="number" name="stok" id="stok" placeholder="stok"
